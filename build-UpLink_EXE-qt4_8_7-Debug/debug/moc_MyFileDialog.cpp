...
#include "../../UpLink_EXE/MyFileDialog.h"
...
static const char qt_meta_stringdata_MyFileDialog[] = {
    "MyFileDialog\0\0slotMyAccept()\0"
};
...
void MyFileDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        MyFileDialog *_t = static_cast<MyFileDialog *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData MyFileDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyFileDialog::staticMetaObject = {
    { &QFileDialog::staticMetaObject, qt_meta_stringdata_MyFileDialog,
      qt_meta_data_MyFileDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyFileDialog::getStaticMetaObject() { return staticMetaObject; }
