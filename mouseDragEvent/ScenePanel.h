...
private:
    ...
    //\用来保存已经添加的按钮画板对象
    QMap<int,SubGphObj*> linkGphObj_;
    ...
    SubGphObj* backgroundSubPanel;

    //定义的圆盘半径
    qreal CIRCLE_RADIUS_ = 150;
    //定义的圆盘宽度
    qreal CIRCLE_WIDTH_ = 60;
    //圆盘缝隙间距
    qreal CIRCLE_GAP_SPACING_ = 1;
    //矩形缝隙间距
    qreal RECT_GAP_SPACING_ = 5;
